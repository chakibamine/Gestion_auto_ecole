...
$dossier = Dossier::selectAlldossier('dossier',$connection->conn);
                    ...
                    <?php
                        ...
                        foreach($dossier as $row) {
                          ...
                          echo " <tr>
                            ...
                            <a class ='btn btn-outline-danger btn-sm p-0 border border-0 fa-lg'  href='delete_dossier.php?id=$row[id]'><i class='bi bi-folder-x'></i></a>
                            </td>
                            </tr>";
                        }
                    ?>   
